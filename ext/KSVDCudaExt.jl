...
"""
@kwdef mutable struct CUDAAcceleratedMatchingPursuit <: KSVD.GPUAcceleratedMatchingPursuit
    max_nnz::Int = KSVD.default_max_nnz
    max_iter::Int = 4*max_nnz
    rtol = KSVD.default_rtol
    batch_size::Int = 1_000
    workspace::Union{BatchedDeviceOpWorkspace{Float32}, Nothing} = nothing
